...
<script>
  ...
  import portIcon from '../../assets/map/Port-terminals.png'
  import deviceIcon from '../../assets/map/Device-Library.png'
  import warningIcon from '../../assets/map/Oil-gas-field-platforms.png'
  import pipeIcon1 from '../../assets/map/tube1.png'
  import pipeIcon2 from '../../assets/map/tube3.png'
  import pipeIcon3 from '../../assets/map/tube2.png'
  import logo from '../../assets/typhoon-logo.png'
  import logoWhite from '../../assets/typhoon-logo-white.png'
  import platformLogo from '../../assets/map/Work-area.png'
  import oilFieldLogo from '../../assets/map/platform.png'
  ...
  export default {
    ...
    computed:{
      ...mapState('moduleMap',{
        ...
        waveFlag: state => state.map.baseLayer[8].active,
        currentFlag: state => state.map.baseLayer[8].active,
        saltFlag: state => state.map.baseLayer[8].active,
        seaTemperatureFlag: state => state.map.baseLayer[8].active,
        airTemperatureFlag: state => state.map.baseLayer[2].active,
        airPressureFlag: state => state.map.baseLayer[1].active,
    ...
    watch:{
      ...
      waveData(){
        this.removeVectorLayer()
        if (this.baseLayerIndex == 8 && this.waveFlag){
      ...
      airTemperatureData(){
        ...
        if (this.baseLayerIndex == 2 && this.airTemperatureFlag){
          this.addVectorLayer('wind',this.windData);
          this.addScalarLayer('airTemp',this.airTemperatureData);
          // this.removeMaskMap();
      ...
      airPressureData(){
        ...
        if (this.baseLayerIndex == 1 && this.airPressureFlag){
    ...
    methods:{
      ...
      addScalarLayer(type,data){
        ...
        switch (type) {
          ...
          case 'airTemp':
            config = {...config, minValue:290,maxValue:305}
            break;
          ...
          case 'seaTemp':
            config = {...config, minValue:270,maxValue:310}
            break;
      ...
      // }
      if (type == 'pressure' || type == 'wind' || type == 'wave'|| type == 'airTemp'){
        this.removeMaskMap()
      }else{
        this.addMaskMap()
      }
